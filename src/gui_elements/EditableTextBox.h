...
private:
    ...
    const uint32_t BG_COLOR = 0xFF244622,
                   BORDER_COLOR = 0xFF000000,
                   TEXT_COLOR = 0xFFFFFFFF,
                   PLACEHOLDER_COLOR = 0xFFCCCCCC,
                   FOCUS_BORDER_COLOR = 0xFF339930,
                   FOCUS_BG_COLOR = 0xFF325822,
                   HOVER_BORDER_COLOR = 0xFF000000,
                   HOVER_BG_COLOR = 0xFF143612,
                   CURSOR_COLOR = 0xFF000000;
    bool inside(int x, int y);
    int findCursorTextPosition(int x);
public:
    EditableTextBox(std::string placeholder, std::string defaultText, int x, int y, int width, int height, bool renderCursor = true);
